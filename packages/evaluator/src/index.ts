...
export { checkProjectGeometry, type CheckProjectGeometryOptions, type GeometryFinding } from './lint.ts';
export { checkProjectDocument, type DocumentFinding } from './document-lint.ts';
