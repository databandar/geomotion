...
// [id, gap-after]. Generous room at the growth reveal (s03), the act itself (s04), and the
// close (s07) — same discipline as Malacca/Arctic: earn the runtime with visual dwell time,
// not padded words.
const GAPS = [
  ['s01', 0.4], ['s02', 0.5], ['s03', 1.2], ['s04', 1.3],
  ['s05', 0.6], ['s06', 0.7], ['s07', 3.4],
];
