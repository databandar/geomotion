/**
 * Rebuilds schedule.json from measured narration. Tight pacing — short gaps.
 */
...
console.log('schedule.json written, DUR =', DUR, 's');
for (const [id] of GAPS) console.log(' ', id, at[id], `→ ${at[id].duration.toFixed(2)}s`);